...
class _SymbolsApi implements SymbolsApi {
  _SymbolsApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<SymbolResponse> fetchSymbols(
    ...
    final _options = _setStreamType<SymbolResponse>(
    ...
    late SymbolResponse _value;
    try {
      _value = SymbolResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
